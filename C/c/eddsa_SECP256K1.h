 ...
 */
extern int EDDSA_SECP256K1_KEY_PAIR_GENERATE(csprng *R, octet *D, octet *Q);
 ...
 *
	...
	@return 0 or an error code
 */
extern int EDDSA_SECP256K1_SIGNATURE(bool ph,octet *D, octet *context,octet *M,octet *SIG);
 ...
 */
extern bool EDDSA_SECP256K1_VERIFY(bool ph,octet *Q,octet *context,octet *M,octet *SIG);
#endif
 ...
 */
extern int EDDSA_Ed448_KEY_PAIR_GENERATE(csprng *R, octet *D, octet *Q);
 ...
 *
	...
	@return 0 or an error code
 */
extern int EDDSA_Ed448_SIGNATURE(bool ph,octet *D, octet *context,octet *M,octet *SIG);
 ...
 */
extern bool EDDSA_Ed448_VERIFY(bool ph,octet *Q,octet *context,octet *M,octet *SIG);
#endif